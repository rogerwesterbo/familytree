...
// Admin endpoints - these will call mock data until backend is implemented
export async function getSystemStats(): Promise<SystemStats> {
  // For now, return the mock data defined above
  // In the future, this will call: adminApiRequest<SystemStats>('/api/v1/admin/stats');
  return {
    cache: {
      enabled: true,
      current_size: 150,
