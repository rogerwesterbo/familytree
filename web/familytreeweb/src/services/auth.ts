...
export const OIDC_CONFIG = {
  ...
  redirectUri: import.meta.env.VITE_REDIRECT_URI || 'http://localhost:15200/callback',
  postLogoutRedirectUri: import.meta.env.VITE_POST_LOGOUT_REDIRECT_URI || 'http://localhost:15200',
  scope: 'openid profile email',
};

// Storage keys
export const STORAGE_KEYS = {
  ACCESS_TOKEN: 'familytree_access_token',
  REFRESH_TOKEN: 'familytree_refresh_token',
  ID_TOKEN: 'familytree_id_token',
  EXPIRES_AT: 'familytree_expires_at',
  CODE_VERIFIER: 'familytree_code_verifier',
  STATE: 'familytree_state',
};
